 ...
 */
WorldRenderer.prototype.renderWorld = function( aWorld, aPlayer )
{
    this._world  = aWorld;
...
{
    Inheritance.super( this, "updateImage", aImage, aNewWidth, aNewHeight );

    var isPortrait = aNewHeight > aNewWidth;
...
// QQQ : remove
var mapRenderer = require( "../../../utils/MapRenderer" );
