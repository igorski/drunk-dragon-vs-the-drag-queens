 ...
 */
module.exports = CaveRenderer;

var Inheritance   = require( "zjslib" ).Inheritance;
var WorldRenderer = require( "../../world/components/WorldRenderer" );
...
{
    Inheritance.super( this, aWidth, aHeight );
}

Inheritance.extend( CaveRenderer, WorldRenderer );
 ...
 */
CaveRenderer.prototype.renderCave = function( aCave, aPlayer )
{
    this._cave   = aCave;
...
// QQQ : remove
var mapRenderer = require( "../../../utils/CaveMapRenderer" );
