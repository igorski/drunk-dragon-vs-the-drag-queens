 ...
 */
function Player( aName, aLevel, aMaxHP, aHP, aMaxMP, aMP, aMaxSP, aSP, aXP, aInventory )
{
    Inheritance.super( this, aName, aLevel, aMaxHP, aHP, aMaxMP, aMP, aMaxSP, aSP );

    this.XP        = aXP || 0;
    this.inventory = aInventory || new Inventory();
}

Inheritance.extend( Player, Character );
